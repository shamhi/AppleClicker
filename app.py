...
async def main(page: ft.Page):
    page.title = "Apple Clicker"
    page.theme_mode = ft.ThemeMode.DARK
    page.bgcolor = "#141221"
    page.vertical_alignment = ft.MainAxisAlignment.CENTER
    page.horizontal_alignment = ft.CrossAxisAlignment.CENTER
    page.fonts = {"Unispace": "fonts/unispace_bd.ttf"}
    page.theme = ft.Theme(font_family='Unispace')
    ...
    async def score_up(event: ft.ContainerTapEvent) -> None:
        ...
        audio = ft.Audio(src='assets/audio/tap.ogg', autoplay=True)
...
if __name__ == '__main__':
    ft.app(target=main, view=None, port=Config.PORT)
